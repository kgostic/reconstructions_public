...
##    -> circ_history: Data on fraction of influenza A circulation caused by H1N1, H2N2 or H3N2 in the specific years and countries of interest. (See function bottom of script for example import of this data.)
